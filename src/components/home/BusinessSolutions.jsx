...
const BUSINESS_SOLUTIONS = [
  {
    title: 'Retail Stores',
    description: 'Shop boards, flex signs, vinyl graphics.',
    icon: (
  ...
  },
  {
    ...
    description: 'Office branding, reception signs.',
    icon: (
      <svg className="w-8 h-8 text-[#1346a8]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  {
    title: 'Showrooms',
    description: 'Premium signage and displays.',
    icon: (
      <svg className="w-8 h-8 text-[#1346a8]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  },
  {
    ...
    description: 'Vehicle branding and mobile advertising.',
    icon: (
      <svg className="w-8 h-8 text-[#1346a8]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
  ...
  {
    title: 'Events',
    description: 'Posters, banners, invitations and more.',
    icon: (
      <svg className="w-8 h-8 text-[#1346a8]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-10 gap-4">
          <div>
            ...
            <p className="text-slate-600 text-sm mt-1">
              Tailored solutions for different industries and requirements.
            </p>
          </div>
          <Link
            to="/services"
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
          {BUSINESS_SOLUTIONS.map((item, idx) => (
            <div
              key={idx}
              className="p-6 rounded-2xl border border-slate-200 bg-white hover:border-[#1346a8]/40 hover:shadow-card-hover transition-all duration-200 flex flex-col group"
            >
